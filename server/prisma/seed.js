...
async function seed() {
  ...
  const TestAcc1 = await prisma.user.create({
    data: {
      name: "TestAcc1",
      password: "$2a$12$KhAwjN8WzTUdYNmAjIN8nuM0XpIFhnfPCmPaimxH9YBr0pufFKBGq",
    },
  });
  const TestAcc2 = await prisma.user.create({
    data: {
      name: "TestAcc2",
      password: "$2a$12$KhAwjN8WzTUdYNmAjIN8nuM0XpIFhnfPCmPaimxH9YBr0pufFKBGq",
    },
  ...
  const post1 = await prisma.post.create({
    data: {
      ...
      title: "Ut elementum mi placerat phasellus varius nisi",
  ...
  const post2 = await prisma.post.create({
    data: {
      ...
      title: "Pellentesque vel sapien nulla morbi at purus sed nibh",
      authorId: TestAcc2.id,
      slug: "post-two",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer placerat urna vel ante volutpat, ut elementum mi placerat. Phasellus varius nisi a nisl interdum",
      tags: {
