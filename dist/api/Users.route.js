...
router.route("/pfp").post(authMiddleware_1.default, (0, express_slow_down_1.default)({
    windowMs: 20000,
    delayAfter: 5,
    delayMs: 2000,
}), Users_controller_1.default.updatePfp);
...
router.route("/profile/image").post(authMiddleware_1.default, (0, express_slow_down_1.default)({
    windowMs: 20000,
    delayAfter: 5,
    delayMs: 2000,
}), Users_controller_1.default.updateProfileImage);
