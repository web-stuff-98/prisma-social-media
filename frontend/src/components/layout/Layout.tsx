        ...
        >
          <main
            ...
            className={
              location.pathname.includes("/editor") ||
              location.pathname.includes("/posts")
                ? "container mx-auto mt-navheader w-full grow bg-foreground dark:bg-darkmodeForeground border-l border-r border-stone-200 shadow dark:border-stone-800 px-2"
                : location.pathname === "/login" ||
                  location.pathname === "/register" ||
                  location.pathname === "/settings" ||
                  location.pathname === "/"
